<template>
    ...
    <div class="login">
       ...
       <input :class="{valide : isValidEmail == true , inValide : isValidEmail == false }" v-model="email" class="input" placeholder="Email" type="email" name="email" required="" >
        
        <input :class="{valide : isStrongPassword == true , inValide : isStrongPassword == false }" v-model="password" class="input" placeholder="Mot de passe" type="password" name="pswd" required="" >
